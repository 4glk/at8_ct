...
void StateAutomate(KeyCode){
    ...
    switch (KeyCode){
        ...
        case 6: IND_OutputFormat(KeyCode, 5,  5,  3);break;     //----- не подключены кнопки
        ...
        case 17: IND_OutputFormat(KeyCode, 5,  5,  3);break;    //отсюда начнутся функции агрегата
        case 18: IND_OutputFormat(KeyCode, 5,  5,  3);break;    //долго конечно , но для начала хватит
